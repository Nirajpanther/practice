...
export default {
  ...
  genterateToken(head) {
    return new Promise((resolve, reject) => {
      Http.get("https://www.universal-tutorial.com/api/getaccesstoken", head)
        .then(function (res) {
          return resolve(res.data);
        })
        .catch(function (err) {
  ...
  getStates(head, country) {
    return new Promise((resolve, reject) => {
      Http.get("https://www.universal-tutorial.com/api/states/" + country, head)
        .then(function (res) {
          return resolve(res.data);
        })
        .catch(function (err) {
  ...
  getCities(head, state) {
    return new Promise((resolve, reject) => {
      Http.get("https://www.universal-tutorial.com/api/cities/" + state, head)
        .then(function (res) {
          return resolve(res.data);
        })
        .catch(function (err) {
